...
**ALWAYS use the `codebase_investigator` sub-agent for any architectural analysis, complex code exploration, or system-wide searches.**
For surgical updates, follow the Research -> Strategy -> Execution lifecycle using specialized tools directly as needed, but defer to `codebase_investigator` for high-level understanding.
...
Rules:
- Never create .md files in the project root (except CLAUDE.md, GEMINI.md, and README.md)
